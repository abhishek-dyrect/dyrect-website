...
function HeroCentered() {
  ...
  const labels = ['Analytics', 'Claims', 'Customers'];
  return (
      ...
      <section className="hero hero--centered">
        <div className="container">
          <div style={{ textAlign: 'center', maxWidth: 880, margin: '0 auto', paddingBottom: 36 }}>
            ...
            <h1 className="display-heading" style={{ fontSize: 'clamp(32px, 4.6vw, 56px)' }}>
              The most <span className="em">seamless</span><br />
              <span style={{ whiteSpace: 'nowrap' }}>warranty management software</span><br />
              <span style={{ display: 'inline-block', verticalAlign: 'baseline' }}>
                for&nbsp;<RotatingWord words={headlineWords} />
              </span>
            </h1>
      ...
      <div className="container">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 460px', gap: 56, alignItems: 'start' }} className="hero-grid">
          <div>
            ...
            <h1 className="display-heading" style={{ fontSize: 'clamp(30px, 4vw, 48px)' }}>
              The most <span className="em">seamless</span><br />
              <span style={{ whiteSpace: 'nowrap' }}>warranty management software</span><br />
              <span style={{ display: 'inline-block', verticalAlign: 'baseline' }}>
                for&nbsp;<RotatingWord words={headlineWords} />
            ...
            <div style={{ display: 'flex', gap: 24, alignItems: 'center', marginTop: 36, color: '#64748B', fontSize: 13 }}>
